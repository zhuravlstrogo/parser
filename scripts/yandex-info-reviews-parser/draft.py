...
# print('final_df')
# print(final_df.head())
print('unique id final df')
print(len(np.unique(final_df['id'])))

final_df['id'] = final_df['id'].astype('int')

info_df = pd.read_csv(f'info_all/{bank_name}_info_all.csv')
info_df = info_df[['city', 'ID']].drop_duplicates()
info_df = info_df[info_df['city'] == "Москва"]

print('unique id info_df ')
print(len(np.unique(info_df['ID'])))
