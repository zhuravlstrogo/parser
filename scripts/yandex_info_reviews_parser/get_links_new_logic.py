...
# ]
    ...
    cities = ['Владивосток',
 'Владикавказ','Вологда','Воркута', 'Екатеринбург',
 'Ессентуки','Иркутск','Кострома','Липецк','Минеральные воды','Мурманск', 'Омск','Орёл','Пятигорск',  'Ростов-на-Дону', 'Самара',
 'Санкт-Петербург', 'Сочи','Сургут',
 'Сызрань',
 'Сыктывкар', 'Тула',
 'Тюмень',
 'Ханты-Мансийск',]
