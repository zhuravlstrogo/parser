...
# ]
    ...
    cities = [ 'Ивантеевка', 'Волгодонск', 'Кашира',
       'Ряжск', 'Дальнегорск', 'Ялуторовск',
       'Лесозаводск', 'Рославль', 'Свердловская Берёзовский', 'Ярославль',
       'Полярные зори', 'Коряжма', 'Малиновский', 'Орёл', 
    ...
    'Старая Русса', 'Льгов', 'Югорск', 'Дедовск', 'Железнодорожный',
       ...
       'Комсомольск-на-Амуре', 'Смоленск', 'Сатка',
      'Покачи', 'Жуковский',
       'Рязань', 'Железногорск', 'Южноуральск', 'Кропоткин',
       'Первоуральск', 'Шилка', 'Щёкино', 'Жирновск', 'Лысьва', 'Тула',
       'Северобайкальск', 'Зима', 'Сосногорск',
       'Кольчугино', 'Ирбит', 
       'Кемеровская Берёзовский', 'Орск',  'Всеволожск',
       'Донской', 'Хасавюрт', 'Южно-Сахалинск', 
       'Салават', 'Октябрьский', 'Сковородино', 'Егорьевск',
     'Когалым', 'Кореновск', 'Краснокаменск', 'Клинцы',
       'Россошь', 'Ханты-Мансийск', 'Серпухов',
     'Лянтор','Нижний Тагил',
      'Тамбов', 'Конаково',
      'Пойковский', 'Тамань', 'Игрим',
        'Истра', 'Слободской', 'Ревда', 'Ишим',
       'Тихвин', 'Горноправдинск', 'Ртищево', 
       'Сыктывкар', 'Осинники', 'Тюмень','Пыть-Ях', 'Лыткарино',
       'Торжок',
       'Кострома', 'Шимановск', 'Сердобск',  'Лабытнанги',
      'Светлоград', 'Коркино',  'Донецк',
       'Старый Оскол'
]
